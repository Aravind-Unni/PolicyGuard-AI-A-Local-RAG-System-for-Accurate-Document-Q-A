...
* **Vector Search:** Utilizes **ChromaDB** and `sentence-transformers` for semantic retrieval.
...
3.  **Embedding:** Chunks are converted into vector embeddings using the `sentence-transformers/all-MiniLM-L6-v2` model.
